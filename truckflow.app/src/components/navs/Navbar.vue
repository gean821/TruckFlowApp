<template>
  ...
  <v-app-bar elevation="0" height="68" class="appbar-dark">
    <div class="appbar-left">
      ...
      <div class="breadcrumb-area">
        <span v-if="breadcrumb.parent" class="breadcrumb-parent">{{
          breadcrumb.parent
        }}</span>
        <v-icon
          v-if="breadcrumb.parent"
          size="12"
    ...
    <div class="appbar-right">
      <div class="appbar-clock">
        <v-icon size="13" color="rgba(255,255,255,0.45)" class="mr-1"
      ...
      <v-menu location="bottom end" transition="slide-y-transition">
        <template #activator="{ props }">
          ...
          >
            ...
            <v-icon size="14" color="rgba(255,255,255,0.4)" class="ml-1"
        ...
        <v-card
          min-width="220"
          elevation="0"
          class="rounded-xl mt-2 dropdown-card"
        >
          <div class="dropdown-header pa-4">
            <div class="d-flex align-center gap-3">
              <v-avatar class="user-avatar-appbar" size="40">
                <v-img v-if="profile.photo" :src="profile.photo" cover />
                <span v-else class="initials-text" style="font-size: 14px">{{
                  profile.initials
                }}</span>
              </v-avatar>
              <div>
  ...
  >
    ...
    <div v-if="!railMode" class="sidebar-profile">
      ...
      <div class="text-white font-weight-bold text-truncate profile-name">
        {{ profile.name }}
      </div>
